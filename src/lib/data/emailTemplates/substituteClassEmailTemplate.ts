export const substituteClassEmailTemplate = `<!doctype html>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p style="margin: 20px 0"><p style="margin: 0 0">Hi {{app.firstName}},</p>Thanks for signing up to substitute {{app.course}} class #{{app.classNumber}} at {{app.date}}! You can find more details about the class on the gbSTEM portal. Once you have taught the class, please be sure to remember to fill out the feedback form for it as well! </p> 
