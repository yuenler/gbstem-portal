                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p style="margin: 20px 0"> <p style="margin: 0 0">Hi {{app.firstName}},</p> Thanks for enrolling for an online {{app.course}} class with us this semester! The class will meet on {{app.class1Time}} and {{app.class2Time}} weekly. The class meeting link is {{app.meetingLink}}. Your instructor will be {{app.instructor}}. You can email them at {{app.instructorEmail}} or email <a target="_blank"
