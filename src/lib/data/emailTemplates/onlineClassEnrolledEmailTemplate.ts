export const onlineClassEnrolledEmailTemplate = `<!doctype html>
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:10px 25px;padding-top:40px;padding-bottom:0px;word-break:break-word;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    style="border-collapse:collapse;border-spacing:0px;">
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:550px;"><img height="auto"
                                                                    src="https://firebasestorage.googleapis.com/v0/b/gbstem-public/o/logoNOBACKGROUND.png?alt=media&token=ccf22ae8-323e-44a6-981c-a314b9563c45"
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                style="font-size:0px;padding:0px 25px 5px 25px;word-break:break-word;">
                                                <div
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p style="margin: 20px 0"> <p style="margin: 0 0">Hi {{app.firstName}},</p> Thanks for enrolling {{app.studentName}} for an online {{app.course}} class with us this semester! The class will meet on {{app.class1Time}} and {{app.class2Time}} weekly. The class meeting link is {{app.meetingLink}}. Your instructor will be {{app.instructor}}. You can email them at {{app.instructorEmail}} or email <a target="_blank"
                                                    ...
                                                    <p style="margin: 30px 0">In the meantime, follow us on <a
                                                            href="https://instagram.com/gbstem">Instagram</a> so you can
                                                        stay up to date on all the exciting things happening with us!
                                                    </p>
                                                            ...
                                                            <td align="center" bgcolor="darkblue" role="presentation"
                                                                ...
                                                                valign="middle"><a
                                                                    ...
                                                                    target="_blank"><b style="font-weight: 700"><b
                                                                            style="font-weight: 700">Return to Dashboard</b></b></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
